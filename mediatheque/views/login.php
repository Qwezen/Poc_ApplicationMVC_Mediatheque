...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
  ...
  <div class="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
    ...
    <p class="text-center text-sm text-gray-600 mt-6">  Pas encore de compte ?<a href="?action=register" class="text-blue-600 hover:underline font-medium">S'inscrire</a>
    </p>
  </div>
